...
class StateTimerPage extends StatefulWidget {
  final int waitTimesInsec;

  const StateTimerPage({Key? key, required this.waitTimesInsec})
      : super(key: key);
...
class _StateTimerPageState extends State<StateTimerPage> {
  ...
  void initState() {
    super.initState();
    _waitTime = widget.waitTimesInsec;
    _calculationTime();
  }
  ...
  void _calculationTime() {
    ...
    setState(() {
      _percent = _waitTime / widget.waitTimesInsec;
